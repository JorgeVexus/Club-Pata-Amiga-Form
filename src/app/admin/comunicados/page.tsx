    ...
    <div className="flex flex-col gap-5 px-5 py-6 md:px-[30px] md:py-[26px]">
      <div className="flex flex-col gap-1">
        ...
        <p className="max-w-[620px] text-sm text-ink-secondary">
          Los correos que la plataforma envía automáticamente. Edita el asunto
          o el cuerpo y guarda — los próximos envíos usarán tu versión. Las
          variables entre llaves se llenan solas con los datos de cada caso.
        </p>
      </div>
