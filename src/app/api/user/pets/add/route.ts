...
export async function POST(request: NextRequest) {
    try {
        ...
        const extendedPetData = {
            ...
            ...(petData.ageUnit ? { age_unit: petData.ageUnit } : {}),
            ...(petData.coatColor ? { coat_color: petData.coatColor } : {}),
            ...(petData.noseColor ? { nose_color: petData.noseColor } : {}),
            ...(petData.eyeColor ? { eye_color: petData.eyeColor } : {}),
