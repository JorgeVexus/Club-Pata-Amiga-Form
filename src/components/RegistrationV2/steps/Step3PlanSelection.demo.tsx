/**
 * Paso 3: Selección de plan - MODO DEMO
 * Simula el checkout de Stripe
 */
...
export default function Step3PlanSelectionDemo({ data, onNext, onBack, showToast }: Step3PlanSelectionProps) {
    ...
    return (
        <div className={styles.stepCard}>
            ...
            <p className={styles.securityNote}>
                🔒 Pago seguro procesado por Stripe (Simulado en Demo)
            </p>
