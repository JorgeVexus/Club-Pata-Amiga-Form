                    ...
                    <tbody>
                        {filteredLogs.map((log) => (
                            <tr key={log.id}>
                                ...
                                <td>
                                    <span className={`${styles.typeBadge} ${log.type === 'app' || log.metadata?.is_custom_notification ? styles.app : styles[log.type]}`}>
                                        {log.type === 'email' ? '📧 Email' : (log.type === 'app' || log.metadata?.is_custom_notification ? '🔔 App' : '💬 WA')}
                                    </span>
                                </td>
