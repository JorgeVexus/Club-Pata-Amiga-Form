...
assert.match(source, /Queremos lo mejor para tu/);
assert.match(source, /Actualmente, no contempla reintegros relacionados con enfermedades genéticas, hereditarias o congénitas/);
assert.match(source, /Nuestro compromiso es brindarte claridad desde el primer día/);
