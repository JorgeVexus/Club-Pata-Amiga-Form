...
(function () {
    ...
    const CONFIG = {
        ...
        DEBUG: false,
        PROFILE_URL: window.PATA_AMIGA_CONFIG?.profileUrl || 'https://www.pataamiga.mx/miembros/perfil',
        SETTINGS_URL: window.PATA_AMIGA_CONFIG?.settingsUrl || 'https://www.pataamiga.mx/miembros/configuracion',
        LOGOUT_URL: window.PATA_AMIGA_CONFIG?.logoutRedirectUrl || 'https://www.pataamiga.mx/'
    };
    ...
    const V2_STYLES = `
        ...
        .amb-v2-brand{display:flex;align-items:center;gap:12px;color:var(--amb-ink);text-decoration:none}
        .amb-v2-mobile-tabbar{display:none}
        ...
        .amb-v2-account-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:15px}.amb-v2-profile{display:flex;align-items:center;gap:14px}.amb-v2-profile img{width:70px;height:70px;border-radius:20px;object-fit:cover}.amb-v2-profile strong{display:block;color:var(--amb-ink);font-size:17px}.amb-v2-profile span{font-size:12px}.amb-v2-detail-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:18px}.amb-v2-detail{padding:12px;border-radius:12px;background:#FAF8F3}.amb-v2-detail span{display:block;color:#9A9388;font-size:9px;font-weight:900;text-transform:uppercase}.amb-v2-detail strong{display:block;margin-top:5px;color:var(--amb-ink);font-size:12px}.amb-v2-account-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}.amb-v2-account-actions a,.amb-v2-account-actions button{min-height:38px;padding:0 15px;display:inline-flex;align-items:center;border:1px solid var(--amb-line);border-radius:999px;background:#fff;color:#087B74;font-weight:900;text-decoration:none;cursor:pointer}.amb-v2-danger{color:#B51F4D!important}
