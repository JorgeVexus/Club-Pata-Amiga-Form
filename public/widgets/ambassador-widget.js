...
(function () {
    ...
    const V2_STYLES = `
        ...
        @media(max-width:760px){.amb-v2-shell{padding:20px 14px 90px}.amb-v2-top{align-items:flex-start}.amb-v2-user strong{display:none}.amb-v2-tabs{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;overflow:visible;padding-bottom:18px}.amb-v2-tab{min-width:0;width:100%;padding:0 10px}.amb-v2-hero-grid,.amb-v2-account-grid{grid-template-columns:1fr}.amb-v2-stat-grid{grid-template-columns:1fr 1fr}.amb-v2-material-grid{grid-template-columns:1fr}.amb-v2-table-head{display:none}.amb-v2-referral{grid-template-columns:1fr auto;gap:8px}.amb-v2-referral>*:nth-child(2){display:none}.amb-v2-referral>*:nth-child(4){grid-column:2;grid-row:1}.amb-v2-membership{align-items:flex-start;flex-direction:column}.amb-v2-membership a{width:100%;box-sizing:border-box;text-align:center}.amb-v2-detail-grid{grid-template-columns:1fr}.amb-v2-code-card{min-height:250px}}
